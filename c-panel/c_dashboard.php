                    ...
                    <div class="card-body position-relative p-4">
                        <div class="row"> 
                            ...
                            <div class="col-12 col-sm-7">
                                <?php
                                $user_id = $_SESSION['$coordinator_user_id'];
                                $sql = "SELECT * FROM coordinator WHERE minister_id = $user_id";
                                $data = mysqli_query($conn, $sql);
                                if (mysqli_num_rows($data) > 0) {
                                    while ($row = mysqli_fetch_assoc($data)) { ?>
                                          <div class="d-flex align-items-center gap-3 mb-5">
                                            <img src="<?php echo $row['image'];  ?>" class="rounded-circle bg-grd-info p-1" width="60" height="60" alt="user">
                                            <div class="">
                                                <!-- <p class="mb-0 fw-semibold">Welcome back</p> -->
                                                <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $_SESSION['username'];  ?></h4>
                                            </div>
                                          </div>
                                <?php  }
                                }
                                     ...
                                     <div class="d-flex align-items-center gap-3 mb-5">
                                        <img src="" class="rounded-circle bg-grd-info p-1" width="60" height="60" alt="user">
                                        <div class="">
                                            <!-- <p class="mb-0 fw-semibold">Welcome back</p> -->
                                            <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $_SESSION['username'];  ?></h4>
                                        </div>
                            ...
                            <div class="col-12 col-sm-5">
                                   <?php
                                   $user_id = $_SESSION['$coordinator_user_id'];
                                   $sql = "SELECT coordinator_title,coordinator_name,church,country,image  FROM coordinator WHERE minister_id = $user_id";
                                   $data = mysqli_query($conn, $sql);
                                   if(mysqli_num_rows($conn, $sql) > 0){
                                     while($row = mysqli_fetch_assoc($data)){?>
                                      <div class="">
                                        <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $row['coordinator_title'];  ?></h4>
                                      </div>
                                      <div class="">
                                        <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $row['coordinator_name'];  ?></h4>
                                      </div>
                                      <div class="">
                                        <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $row['church'];  ?></h4>
                                      </div>
                                    <?php}?>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="">
                                                    <img src="https://placehold.co/110x110/png" class="rounded-circle" width="50" height="50" alt="">
                                                </div>
