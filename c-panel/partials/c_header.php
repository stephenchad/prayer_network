            ...
            <ul class="metismenu" id="sidenav">
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Coordinator Dashboard [<?php echo $_SESSION["username"];  ?>]</div>
                    </a>
                    <ul>
                        <li><a href="c_dashboard.php"><i class="material-icons-outlined">arrow_right</i>Coordinator Dashboard [<?php echo $_SESSION["username"];  ?>]</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Coordinator Profile</div>
                    </a>
                    <ul>
                        <li><a href="uploadCoordinatorProfile.php?page=uploadCoordinatorProfile"><i class="material-icons-outlined">arrow_right</i>Upload Coordinator Profile</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="material-icons-outlined">widgets</i></div>
                        <div class="menu-title">Prayer Session</div>
                    </a>
                    <ul>
                        <li><a href="prayer_session_add.php?page=add_prayer_session"><i class="material-icons-outlined">arrow_right</i>Add Prayer Session</a></li>
                        <li><a href="prayer_session.php?page=prayer_session"><i class="material-icons-outlined">arrow_right</i>Prayer Session</a></li>
                        <li><a href="prayer_session_edit.php?page=edit_prayer_session"><i class="material-icons-outlined">arrow_right</i>Update Prayer Session</a></li>
                        <li><a href="prayer_session.php_delete?page=delete_prayer_session"><i class="material-icons-outlined">arrow_right</i>Delete Session</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="coordinator.php?page=coordinator"><i class="material-icons-outlined">arrow_right</i>Coordinator</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        <div class="parent-icon"><i class="material-icons-outlined">widgets</i></div>
                        <div class="menu-title">Minister</div>
                    </a>
                    <ul>
                        <li><a href="minister.php?page=minister"><i class="material-icons-outlined">arrow_right</i>Minister</a></li>
                    </ul>
                </li>
                ...
                <!-- <li>
                    ...
                    <ul>
                        ...
                        <li><a href="pages-coming-soon.html" target="_blank"><i class="material-icons-outlined">arrow_right</i>Coming Soon</a>
                        </li>
                        <li><a href="pages-starter-page.html" target="_blank"><i class="material-icons-outlined">arrow_right</i>Blank Page</a>
                        </li>
                    </ul>
                </li> -->
                <!-- <li>
