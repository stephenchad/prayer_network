...
<?php session_start() ?>
<?php
$admin_user_id =  $_SESSION["minister_user_id"];
if (!isset($minister_user_id)) {
    header("location:login.php");
}
?>
<?php include("../admin-panel/partials/m_header.php");   ?>
<!--start main wrapper-->
<main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="row">
            ...
            < class="col-xxl-8 d-flex align-items-stretch">
                < class="card w-100 overflow-hidden rounded-4">
                    < class="card-body position-relative p-4">
                        <div class="row">

                            <div class="col-12 col-sm-7">
                                <?php
                                $minister_id = $_SESSION['$minister_user_id'];
                                $sql = "SELECT * FROM minister WHERE minister_id = $minister_id";
                                ...
                                if (mysqli_num_rows($data) > 0) {
                                    while ($row = mysqli_fetch_assoc($data)) {?>
                                     ...
                                     <div class="d-flex align-items-center gap-3 mb-5">
                                            <img src="assets/img/avatar.jpg" class="rounded-circle bg-grd-info p-1" width="60" height="60" alt="user">
                                            <div class="">
                                                <!-- <p class="mb-0 fw-semibold">Welcome back</p> -->
                                                <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php echo $_SESSION['username']; ?>!</h4>
                                            </div>
                            ...
                            <div class="col-12 col-sm-5">
                                <?php
                                    ...
                                    if (mysqli_num_rows($data) > 0) {
                                        while ($row = mysqli_fetch_assoc($data)) {?>
                                              <div class="">
                                                <p class="mb-0 fw-semibold"><?php  echo $row['minister_title']?></p>
                                                <h4 class="fw-semibold mb-0 fs-4 mb-0"><?php  echo $row['minister_name']?></h4>
                                            </div>
                                    <?php  } ?>
                                <?php } ?>
