            ...
            <ul class="metismenu" id="sidenav">
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Minister Dashboard [<?php echo $_SESSION["username"];  ?>]</div>
                    </a>
                    <ul>
                        <li><a href="m_dashboard.php"><i class="material-icons-outlined">arrow_right</i>Minister Dashboard [<?php echo $_SESSION["username"];  ?>]</a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Minister Profile</div>
                    </a>
                    <ul>
                        <li><a href="uploadMinisterProfile.php?page=uploadMinisterProfile"><i class="material-icons-outlined">arrow_right</i>Upload Minister Profile</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li><a href="feedback.php?page=feedback"><i class="material-icons-outlined">arrow_right</i>Provide Feedback</a></li>
                    </ul>
                </li>
