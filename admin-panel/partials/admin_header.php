            ...
            <ul class="metismenu" id="sidenav">
                <li>
                    <a href="javascript:;" class="has-arrow">
                        ...
                        <div class="menu-title">Admin Dashboard [<?php echo $_SESSION["username"];  ?>]</div>
                    </a>
                    <ul>
                        <li><a href="admin_dashboard.php?page=dashboard"><i class="material-icons-outlined">arrow_right</i>Admin Dashboard [<?php echo $_SESSION["username"];  ?>]</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" class="has-arrow">
